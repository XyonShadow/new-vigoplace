...
const { data : categorizedItem, isFetching, isError } = useQuery(["categorizedPost"], fetchCategory);
      ...
      <div className="flex flex-col items-center justify-center">
        <div className="space-y-3">
              {categorizedItem?.data.map((item) => (
                <div className="bg-white w-[220px] rounded-md h-12 p-3 pl-3 flex justify-between" key={item.OPCPostId}>
