...
const fetchuserVolumeTransactionData = async ({
  token,
  startMonth,
  endMonth,
  year,
  ...
  const response = await axios.get(
    `https://api.vigoplace.com/api/admin/console/users/payouts/volume`,
    {
...
const TransactionVolumeByMonth = () => {
  ...
  const {
    ...
    queryFn: () =>
      fetchuserVolumeTransactionData({
        token,
  ...
  const chartSeries = useMemo(
    () => [{ name: "Transaction Volume By Months", data }],
    [data]
  );
...
export default TransactionVolumeByMonth;
